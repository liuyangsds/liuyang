...
func SliceSortInt(arr []int, sort uint8) []int {
	if len(arr) < 2 {
...
func SliceSortString(arr []string, sort uint8) []string  {
	if len(arr) < 2 {
		return arr //这里是直接返回数组
	}
	//fmt.Println("原数据是：",arr)
	//for key,value := range arr {
	//	fmt.Println(key,"==>",value,"==>",value[0],"==>",value[0:1],"==>长度是：",len(value))
	//}
	//0 ==> zhou ==> 122 ==> z ==>长度是： 4
	//1 ==> zhao ==> 122 ==> z ==>长度是： 4
	//2 ==> zong ==> 122 ==> z ==>长度是： 4
...
//删除一个切片元素，返回int类型切片
func SliceDeleteKeyInt(s []int, index int) []int {
...
func SliceDeleteKeyString(s []string, index int) []string {
...
func SliceDeleteKeyIntLength(s []int, index int,length int) []int {
...
func SliceDeleteKeyStringLength(s []string, index int,length int) []string {
...
//复制一个string数组切片
func SliceCopyString(arr []string) []string {
...
func SliceCopyRangeInt(arr []int,start int, length int) []int {
...
func SliceCopyRangeString(arr []string,start int, length int) []string {
